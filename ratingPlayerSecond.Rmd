...
###
```{r echo=FALSE}
inp_data <- readRDS("data/lastSW26082023.RData")
# filter by DATE !!!
inp_data = inp_data %>% filter(game_date > "2023-08-24"  & min > 0 & competition == "Liga Profesional Argentina")
htmltools::tags$link(
...
#TOP 15
ctd[1:15,]$photo = c( "rpcasco","dyjasoto","slhernandez","rpbarco","rparmani",
                       "ccrius","rppdiaz","talsosa", "slgiay","bjgfernandez",
                      "rpperez","rpiovi", "llema", "rpgonzalez",  "rpaliendro")
                       
ctd[1:15,]$Position = c("Def", "Def", "Def", "Med", "Arq",
                        "Med", "Def", "Med", "Med", "Med",
                        "Med", "Def", "Def", "Def", "Med")
...
ctd$value = ""
ctd[1:15,]$value = c("€1.0m","€1.5m","€4.0m","€8.5m","€2.2m",
                     "€0.2m","€4.0m","€4.8m","€4.5m","€2.0m",
                     "€1.0m","€1.7m","€1.5m","€1.2m","€2.0m")
