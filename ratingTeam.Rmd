...
### Plantel Elo calificación: 31-01-2023
```{r echo=FALSE}
t_data <- readRDS("data/lastSW13022023.RData")
# create special dataframe
t_data = t_data %>% filter(game_date > "2023-02-10" & competition == "Liga Profesional Argentina" & min > 0)
