...
### Personal Elo calificación: 19-02-2023
```{r echo=FALSE}
inp_data <- readRDS("data/lastSW18022023.RData")
# filter by DATE !!!
inp_data = inp_data %>% filter(game_date > "2023-02-16" & competition == "Liga Profesional Argentina" & min > 0)
htmltools::tags$link(
...
# top_n
#ctd[1:10,]$photo = c("rpcasco", "slhernandez", "rinsua", "bjvilla", "slcerutti", "rmoreno", "rsigali", "bjadvincula", "dyjasoto", "bjfigal" "dyjasoto" "slhernandez", "slcerutti", "bjvilla", "rhauche", )
#TOP 15
ctd[1:15,]$photo = c("rpcasco",  "hgsoto",  "rmura", "rparmani",  "rmoreno",
                     "rhauche", "rsigali", "hchavez", "hfattori", "hhezze",
                     "htobio", "rpbarco",  "hacevedo",  "rpperez", "tluciatti")
