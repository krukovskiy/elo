...
```{r echo=FALSE}
inp_data <- readRDS("data/lastSW06082023.RData")
inp_profiles <- readRDS("data/PlayersProfiles_06082023.RDS")
# filter by DATE and AGE !!!
mdata = merge(inp_data, inp_profiles, by.x  = "link", by.y = "shortURL")
mdata = mdata %>% filter(`Fecha de nacimiento` > "2002-08-06" & game_date > "2023-07-01" & Nacionalidad == "Argentina")
