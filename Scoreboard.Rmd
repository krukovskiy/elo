...
###                     SCOREBOARD
####                LIGA PROFESIONAL DE FÚTBOL
inp_data <- readRDS("data/lastSW26072023.RData")
inp_data = inp_data %>% filter(game_date > "2023-07-18" & competition == "Liga Profesional Argentina" & min > 0 & is_home == 1) %>% arrange(game_date)

# Фильтруем дубли
inp_data = inp_data[inp_data$game_date != "2023-07-08" | inp_data$team != "Gimnasia La Plata", ]   
